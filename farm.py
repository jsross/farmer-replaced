...
def create_farm_plan(drone, game_board):
	...
	def do_scan_farm():
		...
		quick_print("do_scan_farm: ", get_op_count() - start_op_count)
	...
	def apply_normal_plan():
		apply_entity_type(plant_plan, 0, 0,get_world_size(), get_world_size(), Entities.Carrots, fill_strategy_solid)
		apply_entity_type(plant_plan, 0, 0,get_world_size() , get_world_size(), Entities.Tree,fill_strategy_checkerd)
